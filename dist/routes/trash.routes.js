...
var trash_routes_exports = {};
__export(trash_routes_exports, {
  trashRoutes: () => trashRoutes
});
module.exports = __toCommonJS(trash_routes_exports);
...
// src/routes/trash.routes.ts
var trashRoutes = (0, import_express.Router)();
