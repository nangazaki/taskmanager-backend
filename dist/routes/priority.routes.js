...
var priority_routes_exports = {};
__export(priority_routes_exports, {
  priorityRoutes: () => priorityRoutes
});
module.exports = __toCommonJS(priority_routes_exports);
...
// src/routes/priority.routes.ts
var priorityRoutes = (0, import_express.Router)();
